...
const ReflexedImage = styled.img`transform: rotate(180deg);`;
...
function Board() {
	return (
		<BoardBox>
			...
			<DisplayCardButton>
				<ReflexedImage src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/67170c34-1d99-4e71-9e95-49f54ccde997/ddmch16-160dda32-be57-489a-ab1d-bc4d3eae74de.png/v1/fill/w_300,h_300/left_arrow_sticker_by_s_a_r_c_ddmch16-fullview.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..O6uJnA1LUVCj6MW64Xid2zJ6E7fzDKV-OGeRoWOCivY" />
			</DisplayCardButton>
		</BoardBox>
	);
}
